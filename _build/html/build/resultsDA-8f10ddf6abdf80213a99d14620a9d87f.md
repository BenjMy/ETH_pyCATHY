...
```{figure} ./notebooks/DA_ERT/meshLi_withDA_ic/vtksaturation_slow.gif
...
```{figure} ../notebooks/DA_ERT/meshLi_withDA_ZROOT_WITH_UPDATE//meshLi_withDA_ZROOT_WITH_UPDATEZROOT0.png
:name: true-state-figure
:width: 600px
:align: center
